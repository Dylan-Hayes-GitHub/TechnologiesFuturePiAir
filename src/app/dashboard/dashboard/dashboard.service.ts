...
export class DashboardService {
  ...
  public getSensorData(filterValue: number): any {
    ...
    onValue(sensorQuery, data => {
      ...
      //the filter value is what the user selected to be displayed to the screen
      // ie if last hour then filter value will be 1, 24hours 24, 3 days 72
